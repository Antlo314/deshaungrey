...
export const SEED_RELEASES: Release[] = [
  {
    ...
    links: [
      ...
      { label: "Apple Music", href: "" },
      { label: "YouTube", href: "" },
      { label: "Profile", href: "/artists/dashaun-grey" },
    ],
    featured: true,
    orderIndex: 1,
  },
  ...
  },
  {
    ...
    links: [{ label: "Profile", href: "/artists/dashaun-grey" }],
    featured: true,
    orderIndex: 3,
  },
];
